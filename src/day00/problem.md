...
and the _inputString_ variable may be written differently depending on the best-practice conventions of your submission language.
...
## Explanation
On the first line, we print the string literal **Hello, World..** On the second line, 
we print the contents of the  variable which, for this sample case, happens to be **Welcome to 30 Days of Code!**. 
